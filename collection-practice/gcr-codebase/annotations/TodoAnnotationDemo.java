...
class ProjectTasks {
    ...
    @Todo(task = "Implement user login", assignedTo = "Rahul", priority = "HIGH")
    public void loginFeature() {
        System.out.println("Login feature code...");
    }

    @Todo(task = "Add payment gateway", assignedTo = "Amit") // priority will use default value MEDIUM
    public void paymentFeature() {
        System.out.println("Payment feature code...");
    }

    @Todo(task = "Improve dashboard UI", assignedTo = "Neha", priority = "LOW")
